...
restaurant2 = Restaurant(user_id=1, name="Super Stir Fry", picture="/static/img/2.jpg")
...
restaurant1 = Restaurant(user_id=1, name="Panda Garden", picture="/static/img/3.png")
...
restaurant1 = Restaurant(user_id=1, name="Vegetarian Cuisine ", picture="/static/img/4.jpg")
...
restaurant1 = Restaurant(user_id=1, name="Tony\'s Bistro ", picture="/static/img/5.jpg")
...
# Menu for Andala's
restaurant1 = Restaurant(user_id=1, name="Andala\'s", picture="/static/img/6.jpg")
...
restaurant1 = Restaurant(user_id=1, name="Auntie Ann\'s Diner' ", picture="/static/img/7.jpg")
...
restaurant1 = Restaurant(user_id=1, name="Cocina Y Amor ", picture="/static/img/8.png")
...
restaurant1 = Restaurant(user_id=1, name="State Bird Provisions", picture="/static/img/9.jpg")
session.add(restaurant1)
session.commit()
